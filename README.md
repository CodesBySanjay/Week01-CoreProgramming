...
Welcome to **Week 1** of our Java journey! This repo serves as your foundation for mastering core Java programming concepts — from writing your first program to exploring arrays, strings, and functions.
...
- Method overloading
- The meaning of `static` and `void`
